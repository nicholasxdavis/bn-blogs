(function () {
  ...
  button.className = 'group ml-[-4px] h-[48px] pl-2 pr-4 py-3 bg-[#e2742f] text-white border-l-0 rounded-r-lg shadow-md transform transition-all duration-200 ease-out hover:ml-0 hover:shadow-lg hover:bg-[#e2742f] focus:outline-none flex items-center font-medium border border-white/10 border-l-0 whitespace-nowrap';
